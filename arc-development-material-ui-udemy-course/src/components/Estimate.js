...
// Api Requests
import { sendPlace } from '../services/index'
...
export default function Estimate(props) {
  ...
  const getPlatforms = () => {
    ...
    if (questions.length > 2) {
      questions.filter(question =>
        ...
        .map(question =>
          question.options.filter(option => option.selected))[0]
  ...
  const websiteSelection = (
    <Grid container direction="column"
      ...
      <Grid item container alignItems="center">
        ...
        <Grid item xs={10}>
          <Typography variant="body1">
            You want {category === "Basic" ? "a Basic Website." :
              `an ${category} Website.`}
          </Typography>
        </Grid>
      </Grid>
  ...
  const sendEstimate = () => {
    ...
    sendPlace({
      ...
      total, category, service, platforms, features, customFeatures, users
    })
      .then(res => {
        setLoading(false)
        console.log(res)
  ...
  const estimateDisabled = () => {
    ...
    const emptySelections = questions.map(question =>
      question.options.filter(option =>
        option.selected)).filter(question =>
          question.length === 0)
    ...
    <Grid container direction="row">
      <Grid item container lg direction="column"
        ...
        <Grid item
          style={{
            marginTop: '2em',
            marginLeft: mdDown ? 0 : '5em'
          }}
        >
          <Typography variant="h2" align={mdDown ? "center" : undefined}>
            Estimate
          </Typography>
        </Grid>
        <Grid item
          style={{
            marginRight: mdDown ? 0 : '10em',
            maxWidth: '50em',
            marginTop: '7.5em'
          }}>
      ...
      <Grid item container lg
        direction="column"
        alignItems="center"
        style={{ marginRight: mdDown ? 0 : '2em', marginBottom: '25em' }}
            ...
            <Grid item>
              <Typography variant="h2" align="center"
                style={{
                  ...
                  marginTop: '5em',
                  lineHeight: 1.25,
                  marginLeft: smDown ? '1em' : 0,
                  marginRight: smDown ? '1em' : 0,
                }}
              >
                {question.title}
              </Typography>
        ...
        <DialogContent>
          ...
          >
            ...
            >
              ...
              <Grid item>
                ...
                <Typography variant="body1" align={smDown ? 'center' : undefined} paragraph>
                  ...
                  and we'll get back to you with details moving forward and a final price.
                            </Typography>
              </Grid>
            </Grid>
            ...
            >
              ...
              <Hidden mdUp>
                <Grid item style={{ marginBottom: smDown ? '5em' : 0, marginTop: smDown ? '1em' : 0 }}>
